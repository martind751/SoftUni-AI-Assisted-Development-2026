  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        <h1 className="text-6xl sm:text-7xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">
          SoundScrAIbe
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl w-full mb-14">
          {FEATURES.map((feature) => (
            <div key={feature.title} className="bg-gray-900 rounded-xl p-6 text-center">
        ...
        <button
          onClick={handleLogin}
          className="bg-green-500 hover:bg-green-400 text-black font-semibold px-10 py-3.5 rounded-full text-lg transition-colors"
        >
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">What do you want to explore today?</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {QUICK_LINKS.map((link) => (
            <Link
              key={link.path}
              to={link.path}
              className="bg-gray-900 hover:bg-gray-800 rounded-xl p-5 transition-colors group"
            >
        ...
        {/* Tip */}
        <div className="mt-10 bg-gray-900 rounded-xl p-6 border border-gray-800">
